...
1. [Property Wrapper Selection](#property-wrapper-selection)
2. [Dependency Organization](#dependency-organization)
...
- [Migration Guide](./migration-inject-to-injected.md) - Upgrading from @Inject
- [TCA Integration](./tcaIntegration.md) - Using with The Composable Architecture
- [Performance Guide](./runtimeOptimization.md) - Optimization techniques
- [Testing Guide](../tutorial/testing.md) - Advanced testing patterns
