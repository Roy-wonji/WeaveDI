...
//        defer { lock.unlock() }
//
//        let newInstances = ensureCapacity(currentStorage.instances, for: typeID.id)
//        let newFactories = ensureCapacity(currentStorage.factories, for: typeID.id)
//
...
//
//        let newInstances = Array(currentStorage.instances)
//        let newFactories = Array(currentStorage.factories)
//
...
//    /// 배열 용량 확보
//    @inlinable
//    private func ensureCapacity<T>(_ array: [T], for index: Int) -> [T] {
//        var result = Array(array)
//        while result.count <= index {
//            result.append(nil as! T) // 안전: T는 Optional
//        }
//        return result
//    }
//}
