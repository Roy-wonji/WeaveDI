...
//
//    /// 타입별 직접 생성자
//    private var directCreators: [ObjectIdentifier: Any] = [:]
...
//
//    private var flattenedFactories: [ObjectIdentifier: () -> Any] = [:]
//    private let lock = NSLock()
//
//    /// 의존성 체인을 플래튼화하여 등록
//    @inlinable
...
//    // MARK: - 최적화된 저장소들
//
//    private let fastRegistry = FastDI()
//    private let directRegistry = DirectCallRegistry()
//    private let flattenedRegistry = FlattenedDependencyRegistry()
//
