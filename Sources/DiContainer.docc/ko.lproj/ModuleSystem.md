...
DiContainer 2.0의 모듈 시스템을 활용하여 대규모 애플리케이션의 의존성을 체계적으로 관리하는 방법을 알아보세요.

## 개요

모듈 시스템은 관련된 의존성들을 논리적으로 그룹화하고 체계적으로 관리할 수 있게 해주는 DiContainer의 핵심 기능입니다. Clean Architecture의 각 계층을 모듈로 구성하여 유지보수성과 확장성을 크게 향상시킬 수 있습니다.
