...
#if swift(>=5.9)
@available(iOS 17.0, *)
// Swift 5.9 이상: @Observable 및 @unchecked Sendable 적용
@Observable
public final class DependencyContainer: @unchecked Sendable {
  ...
  // 읽기는 sync, 쓰기는 async(flags: .barrier)로 처리하여 thread safe를 보장합니다.
  ...
  public func register<T>(
    ...
    // registry에 build 클로저를 barrier 플래그를 사용해 동기적으로 저장합니다.
...
// Swift 5.9 미만 버전: Sendable 관련 요구 없이 구현합니다.
