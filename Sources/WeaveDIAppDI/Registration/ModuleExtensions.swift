...
protocol AdvancedModule: Sendable {
  /// 모듈의 고유 식별자
...
/// )
/// ```
struct ConditionalModule: AdvancedModule {
...
/// )
/// ```
struct ModuleGroup: AdvancedModule {
  public let identifier: String
  public let dependencies: [String]
  public let shouldRegister: @Sendable () -> Bool
...
final class ModuleRegistry: ObservableObject {
  ...
  /// 특정 모듈의 등록 상태 확인
  func status(for moduleId: String) -> ModuleRegistrationStatus? {
...
enum ModuleRegistrationStatus: Sendable {
  case registering
  case registered
  case failed(Error)
...
enum ModuleSystemError: Error, LocalizedError {
