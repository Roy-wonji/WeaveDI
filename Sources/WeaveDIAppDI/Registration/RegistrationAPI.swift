...
public enum RegisterAndReturn {
  ...
  @discardableResult
    ...
    public static func extractKeyPathName<T>(_ keyPath: KeyPath<DIContainer, T?>) -> String {
    ...
    public static func isRegistered<T>(_ keyPath: KeyPath<DIContainer, T?>) -> Bool where T: Sendable {
    return DIContainer.shared.resolve(T.self) != nil
  }
}
...
enum RegisterModuleError: Error, LocalizedError, CustomStringConvertible {
...
typealias RegisterModuleResult<T> = Result<T, RegisterModuleError>
...
public extension UnifiedDI {
  ...
  static func registerWithToken<T>(
    ...
    let releaseHandler = DIContainer.shared.register(type, build: factory)
